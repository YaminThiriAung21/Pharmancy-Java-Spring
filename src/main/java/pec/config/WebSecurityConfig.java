...
import pec.security.LoginFailureHandler;
import pec.security.LogoutHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		config.antMatchers("/fonts/**", "/css/**", "/js/**","/images/**", "/login", "/loginError", "/user/**", "/logOut").permitAll()
		.antMatchers("/admin/**").hasAnyRole("ADMIN", "SYSTEM ADMIN", "USER").anyRequest().authenticated();
